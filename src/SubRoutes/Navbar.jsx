...
const Navbar = () => {
    ...
    return (
        <Disclosure as="nav" className="bg-white shadow-xl p-2">
            {({ open }) => (
                <section>
                    <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
                        <div className="relative flex h-16 items-center justify-between">
                            ...
                            <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                                {/* Profile dropdown */}
                                <Menu as="div" className="relative ml-3 flex gap-8 items-center justify-center">
                                    <div>
                                    ...
                                    <div>
                                        <button
                                            className="relative rounded-sm bg-gray-100 text-sm focus:outline-none focus:ring-2 hover:ring-white focus:ring-offset-2 hover:bg-gray-800 p-2 hover:text-white transition border-2 border-gray-600 shadow-md w-[80px]"
                                            onClick={handleClick}
                                        >
                                            Logout
                                        </button>
                                    ...
                                    >
                                        <Menu.Items className="absolute right-0 z-10 mt-[120px] w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                                            <Menu.Item>
                                                {({ active }) => (
                                                    <Link
                                                        to="profile"
